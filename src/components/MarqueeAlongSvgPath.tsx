...
interface MarqueeAlongSvgPathProps {
  ...
  // Custom offsetRotate property
  offsetRotate?: string

  // Fit strategy for scaling: "height", "width", "min" (fits inside container), "max" (covers container)
  fit?: "height" | "width" | "min" | "max"
}
